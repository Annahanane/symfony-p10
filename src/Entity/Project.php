...
class Project
{
    ...
    private ?\DateTimeInterface $checkpoitDate = null;

    #[ORM\Column(type: Types::DATE_MUTABLE, nullable: true)]
    private ?\DateTimeInterface $delivryDate = null;
    ...
    public function getCheckpoitDate(): ?\DateTimeInterface
    {
        return $this->checkpoitDate;
    }

    public function setCheckpoitDate(?\DateTimeInterface $checkpoitDate): self
    {
        $this->checkpoitDate = $checkpoitDate;
